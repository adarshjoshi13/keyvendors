    ...
    phrases.forEach((phrase, index) => {
      ...
      if (phraseIndex !== -1) {
        ...
        sections.push({
          ...
          image: phraseImages[phrase] || null, // Attach image if available
        });
                ...
                <Grid item xs={12} md={6}>
                  <Box
                    dangerouslySetInnerHTML={{
                      __html:
                        index === 0
                          ? highlightText(truncateText(section.content || "No content available.", 50), wordsToHighlight)
                          : highlightText(section.content || "No content available.", wordsToHighlight),
                    }}
