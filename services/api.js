...
export const fetchOrderSummary = async (url, reqData,opt) => {
  try {
    let options =opt?opt: {};
...
export const serviceLocation = async (url, reqData,opt) => {
  try {
    let options =opt?opt: {};
...
export const verifyPeyment = async (url, reqData,opt) => {
  try {
    let options =opt?opt: {};
